...
$(document).ready(function () {
	...
	$("#example").dataTable({
		...
		"bServerSide": true,         
		"bProcessing": true,
		"sAjaxSource": '../AdminServlet1?Page=membertable',
		"aoColumns": [{"mData":"UserId"},{"mData":"FirstName"},{"mData":"IdentityId"},{"mData":"ContactNo"},{"mData":"Email"}]
...
<div id='cssmenu' style="width: 20%; float:left; height:693px; background-image: url(../images/wood.jpg)">
	...
	<div id="content" style="float: left; width:55%; background-color:black; height: 574px; color:white; overflow: auto;">	
		 ...
		 <table id="example">
  			<thead>
    			<tr><th class="site_name">UserId</th><th class="site_name">First Name</th><th class="site_name">Identity Id</th><th class="site_name">Contact No</th><th class="site_name">Email</th></tr>
  			</thead>
  			<tbody>
  			</tbody>
		</table>
		...
		<form action="../AdminServlet1" method="post">
			...
			<p>
	   			...
	   			<input type="hidden" id="page" name="page" value="DeleteStaff"></input>
	   		   <input type="hidden" id="User" name="User" value="Member"></input>
