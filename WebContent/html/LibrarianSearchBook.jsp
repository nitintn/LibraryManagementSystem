...
$(document).ready(function () {
	...
	$("#example").dataTable({
		...
		"bServerSide": true,         
		"bProcessing": true,
		"sAjaxSource": '../LibrarianServlet?Page=datatable1',
...
=======
			...
			<li><a href='jsp/SearchBook.jsp'><span> Search Book</span></a></li>
...
<div id="filler" style="float:left; width: 5%; background-color:black; height: 438px; color:white; background-image: url(../images/wood.jpg)">
	...
	<div id="content" style="float: left; width:60%; background-color:black; height: 438px; color:white; overflow: auto;">	
