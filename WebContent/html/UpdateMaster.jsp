...
<title>Master Profile Update </title>

<link rel="stylesheet" type="text/css" href="css/AddAdmin.css"/>

<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.5.2/jquery.min.js"></script>
<script type="text/javascript" src="http://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/jquery.validate.min.js"></script>
<script type="text/javascript" src="js/UpdateMaster.js"></script>
...
<div id='cssmenu' style="width: 20%; float:left; height:693px; background-image: url(images/wood.jpg)">
	...
	<ul>   
		...
		<li class='has-sub active'><a href='#'><span>Master Profile</span></a>
		<ul>         
	...
	<form action="AdminServlet1" method="get" id="addAdmin_form" style="color: white;">
		<fieldset><legend style="color: white;">Master Profile Update</legend>			
		<% 
				ArrayList<MasterProfileBean> masterList = new ArrayList<MasterProfileBean>();
				masterList = (ArrayList<MasterProfileBean>) request.getAttribute("masterList");
				if(masterList!=null){
			%>
		<p>
			Category:
			<select name="memberType" id="memberType1"> 
			<% for(MasterProfileBean master: masterList) { %>
			<option value="<%=master.getMemberType()%>"><%=master.getMemberType()%></option><%} %>
			</select>
	  	</p>
	  		<p>
	   			<table>
					...
					<tr>
						<td><input type="text" name="Cost" size="30" id="cost1" maxlength="20" onkeypress="return RestrictSpace()" onblur="removeCostText()" onfocus="displayCostText()"/></td>
						<td>
							<div id="costMessage" style="display:none">Please enter Cost</div>
						</td>												
					</tr>
				</table>
	  		</p>
			<p>
				<table>
					<tr>
						<td>
						<label for="NumberOfBook">Number of Book : <span>*</span></label>
						</td>
						<td></td>					
					</tr>
					<tr>
						<td><input id="numberBook" type="text" name="NumberOfBook"size="30" maxlength="20" onkeypress="return RestrictSpace()" onblur="removeBookText()" onfocus="displayBookText()" onkeyup="checkItemAvailability()"/></td>											
					</tr>
				</table>
			</p>
			<p>
				<table>
					<tr>
						<td>
						<label for="NumberOfCd">Number Of Cd : <span>*</span></label>
						</td>
						<td></td>					
					</tr>
					<tr>
						<td><input type="text" name="NumberOfCd" id="numberCd" size="30" disabled maxlength="20" onkeypress="return RestrictSpace()" onblur="removeBookText()" onfocus="displayBookText()" onkeyup="checkItemAvailability()"/></td>											
					</tr>
				</table>
			</p>
	  		<p>	   			
	   			<table>
					<tr>
						<td>
						<label for="NumberOfMagazine">Number Of Magazine : <span>*</span></label>
						</td>
						<td></td>					
					</tr>
					<tr>
						<td><input type="text" name="NumberOfMagazine" id="numberMagazine" size="30" disabled maxlength="20" onkeypress="return RestrictSpace()" onblur="removeBookText()" onfocus="displayBookText()" onkeyup="checkItemAvailability()"/></td>											
					</tr>
				</table>
	   		</p>
	  		<p>
	   			<table>
					<tr>
						<td>
						<label for="NumberOfJournal">Number Of Journal : <span>*</span></label>
						</td>
						<td></td>					
					</tr>
					<tr>
						<td><input type="text" name="NumberOfJournal" id="numberJournal" size="30" disabled maxlength="20" onkeypress="return RestrictSpace()" onblur="removeBookText()" onfocus="displayBookText()" onkeyup="checkItemAvailability()"/></td>											
						<td>
							<div id="uniqueBookMessage" style="display:none">Please enter Number of Books</div>
							<p id="itemAvailabilityMessage"></p>
						</td>	
					</tr>
				</table>
	  		</p>
	  		<p>
	   			...
	   			<input type="hidden" name="Page" value="MasterProfileUpdate"></input>
	   			<input type="hidden" name="isFirst" value="No"></input>
	   			<input type="hidden" name="Submit" value="Update"></input>
	  		</p>	
	  		<%}
	  		else{		
			}
