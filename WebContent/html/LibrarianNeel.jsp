...
<script type="text/javascript"
	src="../js/AdvancedReservationJavaScript.js"></script>

<script type="text/javascript"
	src="../js/SearchItemForReservationScript.js"></script>
...
<form method="post" action="../neel?result=Submit"
	onsubmit="return checkUserDetails()">
...
<table class="rackTable">
	...
	<tr>
		<td></td>
		<td>
		<p id="categoryErr" style="color: red; font-size: xx-small"
			align="right"></p>
		</td>
	</tr>
</table>
...
<table>
	<tr>
		...
		<td>
		<p id="titleErr" style="color: red; font-size: xx-small" align="right"></p>
		</td>
	</tr>
	<tr>
		...
		<td>
		<p id="AuthorErr" style="color: red; font-size: xx-small"
			align="right"></p>
		</td>
	</tr>
	<tr>
		...
		<td><select id="Subject" name="Subject">
			...
			<option value="Romance" id="Romance">Romance</option>
			<option value="Biography" id="Biography">Biography</option>
			<option value="Travel" id="Travel">Travel</option>
			<option value="Tourism" id="Tourism">Tourism</option>
			<option value="Guides" id="Guides">Guides</option>
			<option value="History" id="History">History</option>
			<option value="Geography" id="Geography">Geography</option>
			<option value="Astronomy" id="Astronomy">Astronomy</option>
			<option value="Hands on" id="Hands on">Hands on</option>
		</select></td>
	</tr>
	<tr>
		...
		<td>
		<p id="PublicationErr" style="color: red; font-size: xx-small"
			align="right"></p>
		</td>
	</tr>
</table>
...
<table>
	<tr>
		...
		<td>
		<p id="titleErr1" style="color: red; font-size: xx-small"
			align="right"></p>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td><font style="color: red;">&nbsp;</font>Publication :</td>
		<td><input type="text" id="Publication1" name="Publication1" /></td>
		<td>
		<p id="PublicationErr" style="color: red; font-size: xx-small"
			align="right"></p>
		</td>
...
<table>
	<tr>
		...
		<td>
		<p id="titleErr2" style="color: red; font-size: xx-small"
			align="right"></p>
		</td>
	</tr>
	<tr>
		<td><font style="color: red;">&nbsp;</font> Volume Number :</td>
		<td><input type="text" id="Volume2" name="Volume2" /></td>
		<td>
		<p id="VolumeErr" style="color: red; font-size: xx-small"
			align="right"></p>
		</td>
	</tr>
</table>
...
<table>
	<tr>
		...
		<td>
		<p id="titleErr3" style="color: red; font-size: xx-small"
			align="right"></p>
		</td>
	</tr>
	<tr>
		<td><font style="color: red;">&nbsp;</font> Volume Number :</td>
		<td><input type="text" id="Volume3" name="Volume3" /></td>
		<td>
		<p id="VolumeErr" style="color: red; font-size: xx-small"
			align="right"></p>
		</td>
