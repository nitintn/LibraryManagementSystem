...
<script type="text/javascript" src="../js/AddJournal.js"></script>
...
<link rel="stylesheet" type="text/css" href="../css/AddJournal.css"/>
...
<body  onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="" oncontextmenu="return false;">
	...
	<form action="../AdminServlet1" method="post" id="addJournal_form">
		<fieldset><legend style="color: white;">Add Journal</legend>
			<p>
				<label for="Title" style="color: white;">Title : <span>*</span></label>
				<input id="jouTitle" type="text" name="Title" size="30" onblur="removeText()" onfocus="displayText()">
				
				<div id="titleMessage" style="display:none"><font color=red>Please enter a Journal title</font></div>
			...
			<p>
				...
				<input id="volume" type="text" name="VolumeNo" size="30" disabled  onkeyup="enableVolumeTextBox()"
					...
					<div id="volumeMessage" style="display:none"><font color=red>Please enter journal volume number</font></div>
						<div id="categoryAvailabilityMessage"></div>
			</p>
			<p>
	  		...
	  		<p>
	   			...
	   			<input id="cost" type="text" name="Cost" size="30" disabled  onkeyup="enableCostTextBox()"
					onkeypress="return RestrictSpace()" onblur="removeCostText()" onfocus="displayCostText()">
						...
						<div id="costMessage" style="display:none"><font color=red>Please enter journal cost</font></div>
						<div id="categoryAvailabilityMessage"></div>
	  		</p>
	  		<p>
	   			<input type="submit" value="Submit" name="submit" />
	   			<input type="hidden" name="page" value="AddJournalAdmin"></input>
	   			<form action="../AddJournalAdmin.jsp">
