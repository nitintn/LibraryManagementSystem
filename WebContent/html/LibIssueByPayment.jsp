...
<div id="top-stuff">
	...
	<ul>
		...
		<ul>
			...
			<li class='last'><a href='../AdminServlet1?Page=MasterProfileUpdate&isFirst=first'><span>Update 
...
Master Profile</span></a></li>
	...
	<li class='has-sub active'><a href='#'><span>Issue Item</span></a>     
		<ul>        
			<li><a href='issueItem2.jsp'><span>Issue</span></a></li>  
			<li><a href='issueByPayment.jsp'><span>Issue by Payment</span></a></li>        
			<li class='last'><a href='issueItemReservedInAdvance1.html'>Issue Advance Reserved 
...
<form action="issueItemByPaymentServlet1?pg=lib">
<table border="1">
<tr>
<td></td>
...
<form action="../issueItemByPaymentServlet?pg=lib" id="issueItemFormByPaying">
