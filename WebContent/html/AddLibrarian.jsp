...
<body  onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="" oncontextmenu="return false;">
	...
	<form action="../AdminServlet1" method="post" id="addLibrarian_form">
		<fieldset><legend style="color: white;">Add Librarian</legend>
			<p>
			...
			<div id="EmailMessage" style="display:none"><font color=red>Please enter your Email ID</font></div>				   		
	  		...
	  		<p>
	   			...
	   			<input type="hidden" name="page" value="AddLibrarian"></input>
	  		</p>
		 </fieldset>
	</form>
	</div>
