...
<div id='cssmenu'
	style="width: 20%; float: left; height: 1300px; background-image: url(images/wood.jpg)">
...
<ul>
	...
	<ul>
		<li><a href='html/AddMasterProfile.jsp'><span>Add
...
<%!BookBean been3=null; %> <%been3 = (BookBean)request.getAttribute("been2"); %>
<%!String msg="";
String msg1="";
String msg2="";
String msg3="";
...
<table>
	...
	<tr>
		<td><input type="button" name="page" value="searchItem"
			onclick=" return validateIssueItemForm()"></td>
	</tr>
