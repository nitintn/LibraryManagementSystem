...
<div id='cssmenu' style="width: 20%; float:left; height:1300px; background-image: url(../images/wood.jpg)">
	...
	<div id="content" style="float: left; width:60%; background-color:black; height: 950px;">	
		<fieldset><legend style="color: white;">Delete User</legend>
		<br><br><br>
		<form>
		<center><table>
		<tr>
			<td style="text-align: left;"><label for="userId" style="color:white;">User ID : <span>*</span></label></td>
			<td style="text-align: left;"><input type="text" name="userId" id="userId" size="30" /></td>
		</tr>	
		<tr>
			<td> </td>
			<td> </td>
		...
		<tr>
	   		<td style="text-align: left;"><input type="button" value="Submit" name="Delete" onclick="onChange();"/></td>
	   		<td><input type="hidden" id="page" name="page" value="DeleteUser"></input></td>
		</tr>
		</table></center>
		</form>	
		<center><div id="txtHint" style="color:white;"></div></center>	
		</fieldset>
	</div>
