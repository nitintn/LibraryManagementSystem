...
<body  onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="" oncontextmenu="return false;">
	...
	<form action=../AdminServlet1 method="post" id="addBook_form">
		<fieldset><legend style="color: white;">Add Book</legend>
			...
			<p>
	  		...
	  		<p>
	   			...
	   			<div id="subjectMessage" style="display:none"><font color=red>Please enter description</font></div>
						<div id="categoryAvailabilityMessage"></div>
	   		</p>
	  		<p>
	  		...
	  		<p>
	   			...
	   			<input type="hidden" name="page" value="AddBookAdmin"></input>
	  		</p>
		 </fieldset>
	</form>
	</div>
