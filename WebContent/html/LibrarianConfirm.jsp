...
<ul>
		...
		<ul>
			...
			<li><a href='html/AddBookLibrarian.html'><span>Book</span></a></li>
         
			<li><a href='html/AddCdLibrarian.html'><span>Cd</span></a></li>
         
			<li><a href='html/AddMagazineLibrarian.html'><span>Magazine</span></a></li>
         
			<li class='last'><a href='html/AddJournalLibrarian.html'><span>Journal</span></a></li>
      
		</ul>
		</li>
		
		<li class='last'><a href='html/SearchItemLibrarian.html'><span>Search Item</span></a></li>
	...
	<div id="content" style="float: left; width:60%; background-color:black; height: 1300px;">	
		<fieldset><legend style="color: white;">Confirmation Page</legend>
	...
	<div id="login" style="float:left; width: 20%; background-color:black; height: 1300px; color:white; background-image: url(./images/wood.jpg)">
	</div>
